...
const FALLBACK_FETCHED_AT = "2026-01-01T00:00:00.000Z";

export const FALLBACK_FEED: IntelFeedItem[] = [
  {
    id: "f1",
    displayTime: "07:42",
    publishedAt: "2026-01-01T07:42:00+08:00",
  ...
  },
  {
    id: "f2",
    displayTime: "08:15",
    publishedAt: "2026-01-01T08:15:00+08:00",
    fetchedAt: FALLBACK_FETCHED_AT,
    source: "GDELT",
    region: "国际形势",
    tag: "原油",
  ...
  },
  {
    id: "f3",
    displayTime: "09:06",
    publishedAt: "2026-01-01T09:06:00+08:00",
    fetchedAt: FALLBACK_FETCHED_AT,
    source: "Finnhub",
    region: "海外宏观",
    tag: "美联储",
  ...
  },
  {
    id: "f4",
    displayTime: "10:23",
    publishedAt: "2026-01-01T10:23:00+08:00",
    fetchedAt: FALLBACK_FETCHED_AT,
    source: "AKShare",
    region: "大宗商品",
    tag: "铜 / 煤",
